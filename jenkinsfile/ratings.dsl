...
pipeline {
    ...
    stages {
        ...
        steps {
            ...
            git (branch: 'master'
            , url:'https://github.com/bookinfo-jenkins-project/ratings.git')
        ...
        steps{
            ...
            '''
            script {
                oDockImage = docker.build("winterash2/examples-bookinfo-ratings-v1:${VERSION}", "--pull -t winterash2/examples-bookinfo-ratings-v1:${VERSION} -t winterash2/examples-bookinfo-ratings-v1:latest --build-arg service_version=v1 -f Dockerfile .")
                }
            }
        }
        ...
        stage('Config-Repo PUSH') {
            ...
            steps {
                dir('/var/lib/jenkins/subWorkspace/bookinfo/config'){
                sh '''
                    sed -i "s/examples-bookinfo-ratings-v1:.*/examples-bookinfo-ratings-v1:${VERSION}/g" bookinfo/bookinfo-ratings.yaml
                    git add bookinfo/bookinfo-ratings.yaml
